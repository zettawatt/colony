export const templates = {
  Book: {
    ...
    "@type": "schema:Book",
    "schema:name": "Example Book Title",
  ...
  Movie: {
    "@context": { "schema": "http://schema.org/" },
    "@type": "schema:Movie",
    "schema:name": "Example Movie Title",
  ...
  AutonomiDirectory: {
    ...
    "schema:name": "Richard Feynman Books",
  ...
  CreativeWork: {
    ...
    "schema:name": "Example Creative Work",
